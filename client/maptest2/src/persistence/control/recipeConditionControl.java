...
public class recipeConditionControl implements Initializable {
    ...
    public void initData(Object data,String text){
        list = (List<Recipe_dto>) data;
        // Method What Set Recipe Name In Label
        setRecipeNameInLabel(list);
    }
    ...
    public void showRecipeSearch(ActionEvent actionEvent)throws Exception {
        ...
        initData(requestData.getProtocol_type(), requestData.getProtocol_action()
    ...
    public void nextLevel(ActionEvent actionEvent)throws Exception{
        ...
        list = (List<Recipe_dto>)objectInputStream.readObject();
        if(list.size() != 0){
            setRecipeNameInLabel(list);
            label_page_num.setText(String.valueOf(nextPageNum));
        }
    }
    ...
    public void printData(RequestData requestData){
        System.out.println("================= Printing Current RequestData =================");
        System.out.println("Protocol Type : " + requestData.getProtocol_type());
        System.out.println("Protocol Action : " + requestData.getProtocol_action());
        System.out.println("Protocol Method : " + requestData.getProtocol_method());
        System.out.println("Protocol Contents : " + requestData.getProtocol_contents());
        System.out.println("================= Printing Current RequestData =================");
    }

    public void printData(RequestData requestData, int num){
        System.out.println("================= Printing Current RequestData =================");
